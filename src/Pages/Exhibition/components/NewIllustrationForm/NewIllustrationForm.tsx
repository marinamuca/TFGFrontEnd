...
const NewIllustrationForm = (props: NewIllustrarionFormProps) => {
    ...
    return (
        <FormControl sx={{ m: 3 }}>
            ...
            <DatePicker disableFuture sx={{ mb: 3 }} label="Fecha de realización" format='DD/MM/YYYY' onChange={(e: Dayjs | null) => {setIllustration({...illustration, date: e!.format('YYYY-MM-DD')})}}/>
